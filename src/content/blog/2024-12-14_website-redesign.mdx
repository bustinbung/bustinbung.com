...
I'm really pleased with the result, and the design is also simple enough at its core that I've been able to apply the same visual elements and cues to other things like my resume and business card.
