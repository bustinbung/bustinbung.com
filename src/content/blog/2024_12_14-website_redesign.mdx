...
[^1]: Anytype is a pretty great free and open-source Notion alternative with a focus on privacy and decentralized sync. It has a super deep typing and relations system that's a bit hard to wrap your head around the first time, but it's a really incredible piece of software.
